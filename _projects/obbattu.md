...
img: assets/img/projects/obbattu/obbattu.webp
importance: 
category: personal
...
### Where to view it?
Sadly, I couldn't pay for the server anymore, and hence the project is retired. However, You can still play a few games as captured on the wayback machine here!
Here's one working example! [Wayback Machine - https://Obbattu.xyz](https://web.archive.org/web/20240828181156/https://obbattu.xyz/)
